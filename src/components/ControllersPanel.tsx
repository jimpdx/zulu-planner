...
import { computeFacilityCoverage, splitIntoShifts, isValidTime } from '../utils/coverage'
              ...
              <div className="flex items-center justify-between">
                <div className="font-medium text-sm text-text">
                  {(() => {
                    ...
                    return facility ? <span className="text-accent">{facility.name}</span> : null
                  })()}
                  {' '}{controller.name} <span className="text-accent/60">{controller.timezone}</span>
                </div>
